  ...
  return (
    <div>
      ...
      {(loading || aiAnalysis) && (
        <Card className="mb-6 bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200 dark:from-indigo-950/40 dark:to-purple-950/40 dark:border-indigo-800">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold">AI-анализ от Claude Sonnet 4.5</h3>
          </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <Card>
          <h3 className="font-semibold mb-4">Эффективность по метрикам</h3>
          <ResponsiveContainer width="100%" height={260}>
      ...
      <Card>
        <h3 className="font-semibold mb-4">Лиды по источникам</h3>
